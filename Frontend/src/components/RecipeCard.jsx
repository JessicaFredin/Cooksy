...
const RecipeCard = ({ size = "large" }) => {
  ...
  const cardWidth = "w-[359px]";
  const cardHeight = "h-[463px]";
  const imageHeight = "h-[276px]";
...
<div className="absolute bottom-0 right-0 bg-[#A8D400] text-white px-4 flex items-center w-[calc(100%-40%)] rounded-tl-[10px]">
  <p className="text-sm flex-grow ml-2">{recipeData.author}</p>
